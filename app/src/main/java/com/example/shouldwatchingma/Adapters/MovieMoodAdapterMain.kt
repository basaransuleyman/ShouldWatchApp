...
import kotlinx.android.synthetic.main.home_movies.view.*

class MovieMoodAdapterMain(private val movies:List<Movie>) : RecyclerView.Adapter<MoodHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoodHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.mood_movies,parent,false )
...
class MoodHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
